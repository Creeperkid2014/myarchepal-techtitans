...
const actions = [
  { icon: Camera, label: "New Find", subtitle: "Document discovery", color: "bg-primary", path: "/new-find" },
  { icon: Map, label: "Site Map", subtitle: "View excavation", color: "bg-accent", path: "/site-map" },
  { icon: FlaskConical, label: "Analysis", subtitle: "Lab results", color: "bg-secondary", path: "/analysis" },
  { icon: Users, label: "Team", subtitle: "Collaborate", color: "bg-muted-foreground", path: "/team" },
];
